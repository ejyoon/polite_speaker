...
fig.l0.heat
ggsave("../../04_manuscript/01_general/fig/l0_schematic.png", width = 2.5, height = 4)
```
...
fig.s1
ggsave("../../04_manuscript/01_general/fig/s1_utility_schematic_stateBottom.png", width = 6, height = 4)
```
...
fig.l1 <- ggplot(rs.l1.tidy, 
  ...
  # facet_wrap(. ~ utt, scales = "free_y", ncol=4)+
