...
write.csv(d,
                         file=here("analysis/data/speakerProduction.csv"), # CHANGE FILE NAME AS NEEDED
          row.names=FALSE)

write(toJSON(ms, pretty=TRUE), here("analysis/data/speaker_data.json"))
...
```{r}
setwd(dirname(rstudioapi::getActiveDocumentContext()$path))
raw.data.path <- "../../experiments/prior_elicitation/production-results/"
...
write(toJSON(d, pretty=TRUE), "../../analysis/data/literal_semantics_3heart.json")
```
...
write.csv(d,
                         file="../../analysis/data/literalSemantics.csv", # CHANGE FILE NAME AS NEEDED
          row.names=FALSE)
