...
A separate notion of plausible deniability may not be needed either.
...
A joint cooperative and conflicting relationship was thought necessary for indirect speech \cite{pinker2008}, but here we show indirectness arising from purely cooperative goals \cite{brown1987}, which address different aspects of a general utility structure. 
