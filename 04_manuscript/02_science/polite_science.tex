...
% MCF: I removed the use of ``face'' in this para, as I think it is confusing and a bit circular to define our model in terms of this construct...
...
% MCF: maybe we should remove the ellipsis in the figure - instead ``it wasn't bad.'' to make it match the experiment?
