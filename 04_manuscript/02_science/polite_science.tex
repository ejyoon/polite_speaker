...
\noindent To define this term, the speaker has a weighting of informational vs. social goals to convey ($\phi_{S_{1}}$) and must consider that the listener \(L_1\) reasons about the speaker's goal-weights together with the true state of the world:
