...
transfer in language by assuming that speakers take into account informational \emph{and} social concerns. 
These concerns have been described as polite maxims \cite{leech1983} or social norms \cite{ide1989},
but the most influential account of politeness relies on the notion of \emph{face} to motivate deviations \cite{brown1987, goffman1967}. 
...
maximize their subjective utility \cite{baker2009action,jara2016naive, liu2017ten}.
...
First, the standard \emph{informational utility}
...
Intuitively, if Bob's performance was good, Ann's utilities align: 
...
\enquote{It wasn't bad} -- helps navigate Ann's dilemma. 
By incurring the slightly higher cost involved in producing negation, 
Ann provides a signal to Bob that his performance was probably mediocre,
but that she has Bob's feelings in mind: Why else not say the simpler \enquote{It was good}?
...
Following the theory of politeness as face management \cite{brown1987}, cross-cultural differences in politeness could be a product of different weightings within the same utility structure. 
...
The current model's utility structure could give insights into these speech acts and other behaviors that can be modeled as utility-driven inference in a social context \cite{baker2017rational, hamlin2013mentalistic} where agents need to take into account concerns about both self and others.
