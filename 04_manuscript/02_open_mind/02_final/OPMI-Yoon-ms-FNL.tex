...
{\centering \includegraphics[width=0.56\linewidth]{OPMI-Yoon-figure2-FNL}}
...
\begin{figure}[!t]
\includegraphics[width=0.6\textwidth]{OPMI-Yoon-figure4-FNL} \caption{Full distribution of human responses vs. model predictions. Error bars represent 95\% confidence intervals for the data (vertical) and 95\% highest density intervals for the model (horizontal).}\label{fig:variance}
\end{figure}
