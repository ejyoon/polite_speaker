...
The weight on projecting kindness ($\omega_{pres}$) is also highest for the *be informative* and the *be informative and kind* conditions, though the degree of kindness being projected ($\phi$) varies between these conditions: A greater degree of kindness is projected in the "both goal" relative to the *be informative* condition. 
