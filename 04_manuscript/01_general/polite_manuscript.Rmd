...
but it does not precisely define the competing communicative goals trade off with one another.
...
Worse yet, Bob could infer that Ann is “just being nice”, and think of her as a dishonest, unhelpful speaker. 
...
Our primary behavioral hypothesis was that speakers who found themselves describing bad states (e.g., Bob’s performance was bad) and who had goals to be both informative and kind would produce more indirect, negative utterances (e.g., “It wasn’t terrible”). 
...
These measurements were used in a Bayesian data analysis to approximate the semantics of the words as interpreted by the literal listener agent $L_0$ (see Supplementary Materials for literal semantic results). 
