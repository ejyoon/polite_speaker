...
```{r posteriorParamByGoal,  fig.pos = "!h", out.width="70%", fig.align="center", fig.cap="A utility-centric view of the utility-weight parameters. Relative orderings of the utility-weights across the different goal conditions are consistent."}
