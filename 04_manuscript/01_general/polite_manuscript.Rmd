...
These measurements are used in the Bayesian data analysis to approximate the semantics of the words as interpreted by the literal listener agent $L_0$ (see Supplementary Materials for literal semantic results; see our pre-registered model, hypothesis, and procedure at \red{FIXME}).
...
We put priors over these parameters that were consistent with those used for similar models in this model class: \red{SPEAKER OPTIMALITY PRIORS}.
